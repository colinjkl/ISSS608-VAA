...
```{r}
pacman::p_load(tidyverse, haven, ggplot2, ggpubr, ggthemes)
```
...
```{r}
df$escs <- stu_qqq_SG$ESCS
df$hisei <- stu_qqq_SG$HISEI
df$paredint <- stu_qqq_SG$PAREDINT
df$homepos <- stu_qqq_SG$HOMEPOS
```
