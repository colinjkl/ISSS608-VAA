...
# 3. Programming Interactive Visualizations with R

## 3.1 Learning Outcome

Here, we will learn how to create interactive data visualisation by using functions provided by ggiraph and plotlyr packages.
...
### 3.4.1 Tooltip effect with *tooltip* aesthetics
