...
In this exercise, we will be learning to create the following data visualizations using R packages.
...
We will install and load the required libraries using pacman::p_load function
...
![](images/clipboard-3544997924.png)
...
In this section 23 will learn how to plot a [slopegraph](https://www.storytellingwithdata.com/blog/2020/7/27/what-is-a-slopegraph) by using R.
