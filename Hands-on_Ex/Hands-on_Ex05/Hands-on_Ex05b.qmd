...
# 5b.2 **Installing and Launching R Packages**
...
# 5b.3 **Importing and Preparing The Data Set**
...
# 5b.4 **Building Correlation Matrix: *pairs()* method**
...
## 5b.4.1 Building a basic correlation matrix
...
## 5b.4.2 **Drawing the lower or upper corner**
...
## 5b.4.3 **Including with correlation coefficients**
...
# 5b.5 **Visualising Correlation Matrix: ggcormat()**
...
# 5b.7 **Visualising Correlation Matrix using corrplot Package**
...
## 5b.7.1 **Getting started with corrplot**
...
## 5b.7.2 **Working with visual geometrics**
...
## 5b.7.4 **Working with mixed layout**
...
## 5b.7.5 **Combining corrgram with the significant test**
...
## 5b.7.7 **Reordering a correlation matrix using hclust**
