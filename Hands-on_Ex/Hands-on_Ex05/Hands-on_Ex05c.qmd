...
# 5c.2 **Installing and Launching R Packages**
...
# 5c.3 **Importing and Preparing The Data Set**
...
## 5c.3.3 **Transforming the data frame into a matrix**
...
# 5c.5 **Creating Interactive Heatmap**
...
## 5c.5.7 **Working with colour palettes**
