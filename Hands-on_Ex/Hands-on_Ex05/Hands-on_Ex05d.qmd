...
# **5d.2 Installing and Launching R Packages**
...
# 5d.4 **Plotting Static Parallel Coordinates Plot**
...
## **5d.4.1 Plotting a simple parallel coordinates**
...
## **5d.4.2 Plotting a parallel coordinates with boxplot**
...
## 5d.4.3 **Parallel coordinates with facet**
...
## 5d.4.4 **Rotating x-axis text label**
...
## 5d.4.5 **Adjusting the rotated x-axis text label**
...
# 5d.5 **Plotting Interactive Parallel Coordinates Plot: parallelPlot methods**
...
## 5d.5.3 **Changing the colour scheme**
...
## 5d.5.4 **Parallel coordinates plot with histogram**
