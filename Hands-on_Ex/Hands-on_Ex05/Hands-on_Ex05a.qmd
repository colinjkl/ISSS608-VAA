...
# 5a.2 **Installing and launching R packages**
...
# 5a.4 **Plotting Ternary Diagram with R**

## 5a.4.1 **Plotting a static ternary diagram**
...
## 5a.4.2 **Plotting an interative ternary diagram**
