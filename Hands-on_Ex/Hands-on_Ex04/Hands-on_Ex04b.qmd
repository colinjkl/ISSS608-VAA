...
# 4b.3 **Getting Started**

## 4b.3.1 **Installing and launching R packages**
...
## 4b.3.9 **Significant Test of Association (Depedence) : *ggbarstats()* methods**
...
## 4b.5.1 **Installing and loading the required libraries**

```{r}
pacman::p_load(readxl, performance, parameters, see)
```

## 4b.5.2 **Importing Excel file: readxl methods**
...
## 4b.5.3 **Multiple Regression Model using lm()**
...
## 4b.5.4 **Model Diagnostic: checking for multicolinearity**
...
## 4b.5.5 **Model Diagnostic: checking normality assumption**
...
## 4b.5.6 **Model Diagnostic: Check model for homogeneity of variances**
...
## 4b.5.7 **Model Diagnostic: Complete check**
...
## 4b.5.8 **Visualising Regression Parameters: see methods**
...
## 4b.5.9 **Visualising Regression Parameters: *ggcoefstats()* methods**
