...
As mentioned above there are many different styles of classification which we can use. More details can be found in their [documentations](https://r-spatial.github.io/classInt/reference/classIntervals.html).
